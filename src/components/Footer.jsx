        ...
        <div className="container">
          <div className="footer__grid">
            ...
            <div className="footer__col">
              <h4 className="footer__col-title">La editorial</h4>
              <nav aria-label="Links de la editorial">
                <ul className="footer__links">
                  {['Quiénes somos', 'Nuestros autores', 'Novedades editoriales', 'Catálogo completo'].map(item => (
                    <li key={item}>
                      <button className="footer__link" onClick={() => onNavigate('catalog')}>{item}</button>
                    </li>
                  ))}
                </ul>
              </nav>
